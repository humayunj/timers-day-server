...
exports.update = exports.find = exports.deleteMany = exports.deleteOne = exports.create = void 0;
...
function create(name) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    timer = new Model_1.default({
                        name: name,
                    });
                    return [4 /*yield*/, timer.save()];
                case 1:
                    _a.sent();
                    return [2 /*return*/, {
                            id: timer._id,
...
function deleteMany(id) {
    return Model_1.default.deleteMany({ _id: id });
}
...
function find(query) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Model_1.default.find(query).exec()];
...
function update(id, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Model_1.default.updateOne({ _id: id }, {
                        name: title,
                    })];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, find({ _id: id })];
